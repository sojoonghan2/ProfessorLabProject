...
//	int nObjects = pObjectShader->GetNumberOfObjects();
	...
	CreateCbvSrvDescriptorHeaps(pd3dDevice, 1 + 1 + 1, 1 + 3 + 3); //Player(1), Skybox(1)
//	CreateCbvSrvDescriptorHeaps(pd3dDevice, nObjects + 1 + 1 + 1, 1 + 3 + 3); //Player(1), Skybox(1)
...
ID3D12RootSignature *CScene::CreateGraphicsRootSignature(ID3D12Device *pd3dDevice)
{
	...
	pd3dDescriptorRanges[2].BaseShaderRegister = 1; //t1: gtxtTerrainBaseTexture, t2: gtxtTerrainHeightMapTexture, t3: 
	pd3dDescriptorRanges[2].RegisterSpace = 0;
	pd3dDescriptorRanges[2].OffsetInDescriptorsFromTableStart = D3D12_DESCRIPTOR_RANGE_OFFSET_APPEND;

	pd3dDescriptorRanges[3].RangeType = D3D12_DESCRIPTOR_RANGE_TYPE_SRV;
	pd3dDescriptorRanges[3].NumDescriptors = 3;
	pd3dDescriptorRanges[3].BaseShaderRegister = 4; //t4: gtxtWaterBaseTexture, t5: gtxtWaterDetailTexture, t6: gtxtWaterDetailAlphaTexture
